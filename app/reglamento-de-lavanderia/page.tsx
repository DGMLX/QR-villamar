...
export default function ReglamentoDeLavanderia() {
  ...
  return (
    <main className='pb-10'>
      <div className="flex justify-between py-2 border-t border-blue-500 px-5 items-center">
        ...
        <section>
            <h1 className="text-3xl text-white text-center mt-5 font-light">Reglamento de Lavandería</h1>
            <div className='mt-10 mx-2'>
              <iframe src="https://drive.google.com/file/d/1Q8CGL1O9oJC5IRGntqDQ5os6Iv4NSZfu/preview" style={{width: '100%', height: '100vh', border: 'none'}}></iframe>
